...
const ScrollingTextDouble = () => {
  ...
  const repeatedText1 = `${text1} • ${text1} • ${text1}`;
  const repeatedText2 = `${text2} • ${text2} • ${text2}`;
        ...
        <div style={{ marginBottom: "1rem" }}>
          ...
          >
            {repeatedText1.split("•").map((item, index) => (
              <span
                key={index}
                style={{ margin: "0 2rem", fontSize: "2rem", fontWeight: "bold" }}
              >
                {item.trim()}
              </span>
            ))}
      ...
      >
        ...
        >
          ...
          >
            ...
            <br />
            <span style={{ color: "white" }}>creative & scalable</span>
            <br />
      ...
      <section id="about" style={{ padding: "4rem 2rem", borderTop: "1px solid white" }}>
        ...
        >
          <div>
            ...
            <p style={{ color: "white", lineHeight: "1.8", marginBottom: "1.5rem", fontSize: "1rem" }}>
              I’m familiar with <span style={{ color: "#ff2d20", fontWeight: "bold" }}>Laravel</span>,{" "}
              <span style={{ color: "#1572b6", fontWeight: "bold" }}>CSS</span>,{" "}
              <span style={{ color: "#f7df1e", fontWeight: "bold" }}>JavaScript</span>, and{" "}
              <span style={{ color: "#61dafb", fontWeight: "bold" }}>React.js</span>. You can also check out more of my work through my{" "}
              <a
            ...
            <p style={{ color: "white", lineHeight: "1.8", fontSize: "1rem" }}>
              ...
              <span style={{ color: "red", fontWeight: "bold" }}>UI/UX design</span>, as I enjoy creating solutions that are not only functional but also intuitive for users.
            </p>
          </div>
          ...
          <div>
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <div style={{ color: "rgba(190,186,186,1)", fontSize: "0.8rem", fontStyle: "italic" }}>
        ...
        <div style={{ marginTop: "4rem" }}>
          ...
          <div style={{ textAlign: "center" }}>
            <h3 style={{ fontSize: "1.5rem", fontWeight: "600", marginBottom: "2rem", color: "white" }}>
              TECH I USED
            </h3>
            <ScrollingTechImages />
          </div>
